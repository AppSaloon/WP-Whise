...
<table class="form-table">
    ...
    <tr>
        ...
        <td>
            ...
            <p class="description" id="tagline-description"><?php _e( 'The project status.', 'wp_whise' ); ?></p>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            ...
            <p class="description" id="tagline-description"><?php _e( 'The project program.', 'wp_whise' ); ?></p>
        </td>
    </tr>
